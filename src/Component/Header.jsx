                            ...
                            <div className="offcanvas-body p-3" >
                                <ul className="navbar-nav">
                                    <li className="nav-item">
                                        <Link className={`nav-link text-center rounded-1  ${location.pathname === "/" ? "active" : ""}`} to="/" onClick={() => setIsOpen(false)} style={{ color: 'black', margin: "10px 0px 10px 0px" }}><FaHome className='fs-3 ' /></Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link className={`nav-link text-center rounded-1 ${location.pathname === "/aboutus" ? "active" : ""}`} to="/aboutus" onClick={() => setIsOpen(false)} style={{ color: 'black', margin: "10px 0px 10px 0px" }}>About</Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link className={`nav-link text-center rounded-1 ${location.pathname === "/product" ? "active" : ""}`} to="/product" onClick={() => setIsOpen(false)} style={{ color: 'black', margin: "10px 0px 10px 0px" }}>Product</Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link className={`nav-link text-center rounded-1 ${location.pathname === "/blog" ? "active" : ""}`} to="/blog" onClick={() => setIsOpen(false)} style={{ color: 'black', margin: "10px 0px 10px 0px" }}>Blog</Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link className={`nav-link text-center rounded-1 ${location.pathname === "/contact" ? "active" : ""}`} to="/contact" onClick={() => setIsOpen(false)} style={{ color: 'black', margin: "10px 0px 10px 0px" }}>Contact</Link>
                                    </li>
                                </ul>
                            </div>
                        </div>
